...
export default function App() {
  const [movies, setMovies] = useState(tempMovieData); //state to handle display movies in MovieList
  const [watched, setWatched] = useState([]); //State to handle watched movies
  ...
  const [selectedId, setSelectedId] = useState(null); //state for a selected movie
  ...
  return (
    <>
      ...
      {/*<Main movies={movies}>inorder to avoid prop drilling we use component composition by passing children instead of props */}
      <Main>
        {/*<ListBox movies={movies}/>inorder to avoid prop drilling we use component composition by passing children instead of props*/}
        {/*<ListBox> //Replace ListBox with reusable component Box
          <MovieList movies={movies} />
          //inorder to avoid prop drilling we use component composition by passing children instead of props
        </ListBox>
        */}
...
/*NavBar contains 3major components Logo, Search and NumResult .search and NumResults are passed as children*/
